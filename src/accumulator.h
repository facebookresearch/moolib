...
struct Accumulator {
  ...
  Accumulator(std::string name, py::object parameters, py::object buffers);
  Accumulator(const Group& group, std::string name, py::object parameters, py::object buffers);
  ~Accumulator();
